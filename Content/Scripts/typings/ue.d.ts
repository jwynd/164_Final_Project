...
declare class ReplicablePrefabActor extends PrefabActor { 
	static GetDefaultObject(): ReplicablePrefabActor;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): ReplicablePrefabActor;
	static C(Other: UObject | any): ReplicablePrefabActor;
}

declare class PrefabRandomizer extends Actor { 
	bRandomizeOnBeginPlay: boolean;
	SeedOffset: number;
	MaxBuildTimePerFrame: number;
	static GetDefaultObject(): PrefabRandomizer;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): PrefabRandomizer;
	Randomize(InSeed: number): void;
	static C(Other: UObject | any): PrefabRandomizer;
}

declare class PrefabricatorAssetCollectionItem { 
	PrefabAsset: PrefabricatorAsset;
	Weight: number;
	clone() : PrefabricatorAssetCollectionItem;
	static C(Other: UObject | any): PrefabricatorAssetCollectionItem;
}

declare class PrefabricatorAssetCollection extends PrefabricatorAssetInterface { 
	Prefabs: PrefabricatorAssetCollectionItem[];
	Version: any;
	static Load(ResourceName: string): PrefabricatorAssetCollection;
	static Find(Outer: UObject, ResourceName: string): PrefabricatorAssetCollection;
	static GetDefaultObject(): PrefabricatorAssetCollection;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): PrefabricatorAssetCollection;
	static C(Other: UObject | any): PrefabricatorAssetCollection;
}

declare class PrefabricatorAssetUserData extends AssetUserData { 
	PrefabActor: any;
	ItemID: Guid;
	static Load(ResourceName: string): PrefabricatorAssetUserData;
	static Find(Outer: UObject, ResourceName: string): PrefabricatorAssetUserData;
	static GetDefaultObject(): PrefabricatorAssetUserData;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): PrefabricatorAssetUserData;
	static C(Other: UObject | any): PrefabricatorAssetUserData;
}

declare class PrefabricatorBlueprintLibrary extends BlueprintFunctionLibrary { 
	static Load(ResourceName: string): PrefabricatorBlueprintLibrary;
	static Find(Outer: UObject, ResourceName: string): PrefabricatorBlueprintLibrary;
	static GetDefaultObject(): PrefabricatorBlueprintLibrary;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): PrefabricatorBlueprintLibrary;
	static SpawnPrefab(WorldContextObject: UObject,Prefab: PrefabricatorAssetInterface,Transform: Transform,Seed: number): PrefabActor;
	static RandomizePrefab(PrefabActor: PrefabActor,InRandom: RandomStream): void;
	static GetAllAttachedActors(Prefab: Actor,AttachedActors?: Actor[]): {AttachedActors: Actor[]};
	static C(Other: UObject | any): PrefabricatorBlueprintLibrary;
}

declare type EPrefabricatorPivotPosition = 'ExtremeLeft' | 'ExtremeRight' | 'Center' | 'EPrefabricatorPivotPosition_MAX';
declare var EPrefabricatorPivotPosition : { ExtremeLeft:'ExtremeLeft',ExtremeRight:'ExtremeRight',Center:'Center',EPrefabricatorPivotPosition_MAX:'EPrefabricatorPivotPosition_MAX', };
declare class PrefabricatorSettings extends DeveloperSettings { 
	PivotPosition: EPrefabricatorPivotPosition;
	bAllowDynamicUpdate: boolean;
	static Load(ResourceName: string): PrefabricatorSettings;
	static Find(Outer: UObject, ResourceName: string): PrefabricatorSettings;
	static GetDefaultObject(): PrefabricatorSettings;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): PrefabricatorSettings;
	static C(Other: UObject | any): PrefabricatorSettings;
}

declare class PrefabSeedLinkerComponent extends SceneComponent { 
	EditorSpriteTexture: Texture2D;
	static Load(ResourceName: string): PrefabSeedLinkerComponent;
	static Find(Outer: UObject, ResourceName: string): PrefabSeedLinkerComponent;
	static GetDefaultObject(): PrefabSeedLinkerComponent;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): PrefabSeedLinkerComponent;
	static C(Other: UObject | any): PrefabSeedLinkerComponent;
}

declare class PrefabSeedLinker extends Actor { 
	LinkedActors: any[];
	SeedLinkerComponent: PrefabSeedLinkerComponent;
	static GetDefaultObject(): PrefabSeedLinker;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): PrefabSeedLinker;
	static C(Other: UObject | any): PrefabSeedLinker;
}
...
declare class PrefabricatorActorFactory extends ActorFactory { 
	static Load(ResourceName: string): PrefabricatorActorFactory;
	static Find(Outer: UObject, ResourceName: string): PrefabricatorActorFactory;
	static GetDefaultObject(): PrefabricatorActorFactory;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): PrefabricatorActorFactory;
	static C(Other: UObject | any): PrefabricatorActorFactory;
}

declare class PrefabricatorAssetFactory extends Factory { 
	static Load(ResourceName: string): PrefabricatorAssetFactory;
	static Find(Outer: UObject, ResourceName: string): PrefabricatorAssetFactory;
	static GetDefaultObject(): PrefabricatorAssetFactory;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): PrefabricatorAssetFactory;
	static C(Other: UObject | any): PrefabricatorAssetFactory;
}

declare class PrefabricatorAssetCollectionFactory extends Factory { 
	static Load(ResourceName: string): PrefabricatorAssetCollectionFactory;
	static Find(Outer: UObject, ResourceName: string): PrefabricatorAssetCollectionFactory;
	static GetDefaultObject(): PrefabricatorAssetCollectionFactory;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): PrefabricatorAssetCollectionFactory;
	static C(Other: UObject | any): PrefabricatorAssetCollectionFactory;
}

declare class PrefabricatorAssetThumbnailRenderer extends DefaultSizedThumbnailRenderer { 
	static Load(ResourceName: string): PrefabricatorAssetThumbnailRenderer;
	static Find(Outer: UObject, ResourceName: string): PrefabricatorAssetThumbnailRenderer;
	static GetDefaultObject(): PrefabricatorAssetThumbnailRenderer;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): PrefabricatorAssetThumbnailRenderer;
	static C(Other: UObject | any): PrefabricatorAssetThumbnailRenderer;
}
